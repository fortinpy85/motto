...
ALLOWED_HOSTS = [SITE_URL.hostname, "localhost", "127.0.0.1", "django-service", "192.168.68.109"]

# Application definition
INSTALLED_APPS = [
    # Third-party apps
    # "daphne",  # Removed - using WSGI due to middleware async compatibility issues
    "django_structlog",
    "modeltranslation",
    "django_prometheus",
...
MIDDLEWARE = [
    ...
    # TEMPORARY: Auto-login middleware for local testing (REMOVE FOR PRODUCTION!)
    "otto.utils.test_auth_middleware.AutoLoginMiddleware",
    "otto.utils.middleware.ExtendSessionMiddleware",
    "django.middleware.locale.LocaleMiddleware",
    "otto.utils.middleware.TimezoneMiddleware",
    # "data_fetcher.middleware.GlobalRequestMiddleware",  # Module not available - commented out
...
# Configure authentication backends for both test and development environments
# Rules backend is required for object-level permissions (e.g., chat access)
...
# ASGI_APPLICATION = "otto.asgi.application"  # Temporarily disabled - using WSGI due to middleware async compatibility issues
